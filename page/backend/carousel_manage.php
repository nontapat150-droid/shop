...
<div class="<?php echo $bg?> mt-5 shadow-sm p-4 mb-4" style="border-radius: 1vh;" data-aos="fade-down">
    <center>
        <h1 class="">&nbsp;<i class="fa-duotone fa-image"></i>&nbsp;จัดการภาพสไลด์</h1>
    </center>
    <hr>
    <div class="d-flex justify-content-center">
        <button class="ms-2 me-2 mt-3 mb-0 btn bg-main col-12 col-lg-5 text-white" id="open_insert"> เพิ่มภาพใหม่</button>
    </div>
        ...
        <table id="table" class="table mt-2">
            <thead class="table">
                <tr class="">
                    ...
                    <th class="text-center"> ลิงค์รูปภาพ</th>
            ...
            <tbody>
                ...
                ?>
                    <tr >
                        ...
                        <td class="text-center"><img src="<?php echo htmlspecialchars($row['link']);?>" width="100px" srcset=""></td>
                        <td class="text-center"><button class="btn btn-warning text-white w-100" style="width : 130px!important" onclick="get_detail(<?php echo $row['id'];?>)"><i class="fa-solid fa-pencil text-white"></i>&nbsp;แก้ไข</button></td>
                        <td class="text-center"><button class="btn btn-danger text-white w-100"  style="width : 130px!important" onclick="del('<?php echo $row['id'];?>','<?php echo htmlspecialchars($row['username']);?>')"><i class="fa-solid fa-trash text-white" ></i> ลบ</button></td>
                    </tr>
                <?php
                    }
                ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content bg-glass">
            <div class="modal-header">
                <h5 class="modal-title" style="color: var(--font);" id="exampleModalLabel"><i class="fa-duotone fa-pencil"></i>&nbsp;&nbsp;แก้ไขรูปภาพสไลด์</h5>
        ...
        <div class="modal-content bg-glass">
            ...
            <div class="modal-body">
                <div class="col-lg-10 m-cent ">
                    <div class="mb-2">
                        <div class="mb-2">
                            <p class="mb-1" style="color: var(--font);">ลิ้งค์รูปภาพสไลด์<span class="text-danger">*</span></p>
