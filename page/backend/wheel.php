<?php
if (isset($_GET['id'])) {
    $find = dd_q("SELECT * FROM wheel WHERE id = ? ", [$_GET['id']]);
    ...
    <div class="container-sm <?php echo $bg?> mt-5 shadow-sm p-4 mb-4" style="border-radius: 1vh;" data-aos="fade-down">
        ...
        <div class="table-responsive mt-3 ">
            <table id="table" class="table mt-2">
                ...
                <tbody>
                    <?php
                    $get_user = dd_q("SELECT * FROM  wheel_item WHERE w_id = ?  ORDER BY id DESC",[$_GET['id']]);
            ...
            <div class="modal-content bg-glass">
                ...
                <div class="modal-body">
                    <div class="col-lg-10 m-cent ">
                        <div class="mb-2">
                            <div class="mb-2">
                                <p class=" mb-1" style="color: var(--font);">ชื่อรางวัล <span class="text-danger">*</span></p>
                            ...
                            <div class="mb-2">
                                <p class=" mb-1" style="color: var(--font);">โอกาสออก สูงสุด 100% <span class="text-danger">*</span></p>
