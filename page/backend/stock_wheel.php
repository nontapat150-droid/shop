...
?>
<div class="container-sm <?php echo $bg?>  mt-5 border-2 shadow-sm p-4 mb-4" style="border-radius: 1vh;" data-aos="fade-down">
    <center>
    ...
    <div class="modal-dialog">
        <div class="modal-content bg-glass">
            <div class="modal-header">
                <h5 class="modal-title" style="color: var(--font);" id="exampleModalLabel"><i class="fa-duotone fa-circle-plus"></i>&nbsp;&nbsp;เพิ่มสต็อก</h5>
            ...
            <div class="modal-body">
                <div class="col-lg-10 m-cent ">
                    <div class="mb-2">
                        <div class="mb-2">
                            <p class=" mb-0" style="color: var(--font);">ใส่รางวัล <span class="text-danger">*</span></p>
                            <small class="mb-1 mt-0" style="color: var(--font);">การขึ้นบรรทัดใหม่จะนับเป็นรางวัลใหม่ทันที </small>
                            <textarea  id="stock_data" cols="30" rows="10" class="form-control" onkeyup="count_stock()"></textarea>
                            <p class="mb-0 mt-2" style="color: var(--font);">ตอนนี้นับได้ : <span class="text-danger" id="count_stock">0</span> ชิ้น </p>
                        </div>
                    </div>
...
<div class="modal fade" id="product_salt" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content bg-glass">
            <div class="modal-header">
                <h5 class="modal-title" style="color: var(--font);" id="exampleModalLabel"><i class="fa-duotone fa-pencil"></i>&nbsp;&nbsp;แก้ไขโอกาสเกลือ</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="col-lg-10 m-cent ">
                    <div class="mb-2">
                        <div class="mb-2">
                            <p class=" mb-1" style="color: var(--font);">โอกาสเกลือ (สูงสุด 100 %) <span class="text-danger">*</span></p>
                            <input type="text" id="p_salt" class="form-control" value="<?php echo $pd['percent'];?>">
                        </div>
                        <div class="mb-2">
                            <p class=" mb-1" style="color: var(--font);">ของรางวัลหากได้เกลือ <span class="text-danger">*</span></p>
...
<div class="modal fade" id="product_detail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content bg-glass">
            <div class="modal-header">
                <h5 class="modal-title" style="color: var(--font);" id="exampleModalLabel"><i class="fa-duotone fa-pencil"></i>&nbsp;&nbsp;แก้ไขรางวัล</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="col-lg-10 m-cent ">
                    <div class="mb-2">
                        <div class="mb-2">
                            <p class=" mb-0" style="color: var(--font);">แก้ไขรางวัล <span class="text-danger">*</span></p>
