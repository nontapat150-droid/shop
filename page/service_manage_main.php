    ...
    <center>
            <div class="col-12 col-lg-12 p-2 mb-2" style="border-radius: 1vh;">
                <div class="d-flex justify-content-between">
                    ...
                    <button class="btn nav-link align-self-center <?php echo $bg?> shadow-sm border" onclick="window.history.back()" style="height: fit-content;"><b><i class="fa-solid fa-turn-down-left"></i> ย้อนกลับ</b></button>
                </div>
            </div>
        </center>
    ...
    <div class="modal-dialog">
        <div class="modal-content bg-glass">
            <div class="modal-header">
                <h5 class="modal-title " style="color: var(--font);" id="exampleModalLabel"><i class="fa-duotone fa-pencil"></i>&nbsp;&nbsp;เพิ่มสินค้า</h5>
            ...
            <div class="modal-body">
                <div class="col-lg-10 m-cent ">
                    <div class="mb-2">
                        <div class="mb-2">
                            <p class="mb-1" style="color: var(--font);">ชื่อสินค้า <span class="text-danger">*</span></p>
                        ...
                        <div class="mb-2">
                            <p class="mb-1" style="color: var(--font);">ราคาสินค้า <span class="text-danger">*</span></p>
                            <input type="text" id="p_price" class="form-control" value="0">
                        </div>
                        <div class="mb-2">
                            <p class="mb-1" style="color: var(--font);">หมวดหมู่สินค้า <span class="text-danger">*</span></p>
